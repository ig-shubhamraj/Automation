...
public class JaCoCoMain {
    private static JaCoCoCoffeeMaker coffeeMaker;
	...
	public static void addRecipe() {
		...
		JaCoCoRecipe r = new JaCoCoRecipe();
		try {
			r.setName(name);
    ...
    public static void deleteRecipe() {
        JaCoCoRecipe[] recipes = coffeeMaker.getRecipes();
    ...
    public static void editRecipe() {
	    ...
	    JaCoCoRecipe newRecipe = new JaCoCoRecipe();
	    try {
