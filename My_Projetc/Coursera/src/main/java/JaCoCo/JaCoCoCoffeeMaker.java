...
public class JaCoCoCoffeeMaker {
	/** Array of recipes in coffee maker */
	private static JaCoCoRecipeBook recipeBook;
     ...
     */
	public JaCoCoCoffeeMaker() {
	    recipeBook = new JaCoCoRecipeBook();
	 ...
	 * @return boolean
	 */
	public boolean addRecipe(JaCoCoRecipe r) {
	 ...
	 * @return String
	 */
	public String editRecipe(int recipeToEdit, JaCoCoRecipe r) {
